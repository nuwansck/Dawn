...
| Version | Date | Change |
|---|---|---|
| 1.3 | 2026-05-02 | Realistic M15 exit update. TP changed from `range × 1.50` to `range × 1.00`, RR cap lowered to `2.5`, daily trade cap aligned to 2, startup Telegram now shows exact SL/TP logic, and trade-open Telegram now includes SL/TP calculation + broker confirmation check. |
